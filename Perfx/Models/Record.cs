namespace Perfx
{
    ...
    public class Run
    {
        ...
        public double dur_90_per_s => this.ok_records_durations_ms.Count > 0 ? Math.Round(this.ok_records_durations_ms.Percentile(90), 2) : 0;
        public double dur_95_per_s => this.ok_records_durations_ms.Count > 0 ? Math.Round(this.ok_records_durations_ms.Percentile(95), 2) : 0;
        public double dur_99_per_s => this.ok_records_durations_ms.Count > 0 ? Math.Round(this.ok_records_durations_ms.Percentile(99), 2) : 0;
